import { View, Text, SafeAreaView, FlatList, Platform, Image, RefreshControl, Alert } from 'react-native'
...
import useAppwrite from '../../lib/useAppwrote'
...
const Home = () => {
  ...
  return (
    <SafeAreaView  className='bg-primary h-full'>
      <FlatList 
        style={Platform.OS === 'android' ? { marginTop: 30 } : {}}
        data={posts}
